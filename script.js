...
thediv208.innerHTML=thediv208.innerHTML+'<svg height='(h+10)' width='+(w+10)+' style="position:absolute; left:'+tx+'px; top:'+ty+'px; ">  <ellipse cx='+x+' cy='+y+' rx='+w+' ry='+h+' style='+st+' /></svg> ';
/*
